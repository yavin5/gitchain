 ...
 * 4. Commit and push the updated js/chain.js to GitHub (do not commit admin.key or src/admin-address.ts).
 *
 * How to Make New Coins:
 * - Only the admin can make new coins.
...
console.log(`Next: npm run build, then commit/push js/chain.js (do not commit admin.key or src/admin-address.ts).`);
